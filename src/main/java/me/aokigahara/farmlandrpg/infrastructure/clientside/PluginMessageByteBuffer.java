package me.aokigahara.farmlandrpg.infrastructure.clientside;
...
public class PluginMessageByteBuffer implements IPluginMessageByteBuffer {
    ...
    public void writeDouble(double value) {
        ...
        // Преобразуем double в long представление и записываем его как 8 байт
    ...
    public double readDouble() {
        ...
        // Читаем 8 байт как long и преобразуем обратно в double
